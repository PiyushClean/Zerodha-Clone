    ...
    <>
      <div className="container">
        ...
        <div className="row p-5  ">
          ...
          <div className="col-4 p-5 mt-2 mb-2">
            <h4> <i class="fa fa-bar-chart"></i> Your Zerodha Account</h4>
          ...
          <div className="col-4 p-5 mt-2 ">
            <h4> <i class="fa fa-plus-circle"></i> Kite</h4>
        ...
        <div className="row  px-5   mb-5">
          <div className="col-4 p-5  mb-2">
            <h4> <i class="fa fa-briefcase"></i> Funds</h4>
          ...
          <div className="col-4 p-5 mt-2 mb-2">
            <h4> <i class="fa fa-spinner"></i> Console</h4>
          ...
          <div className="col-4 p-5 mt-2 mb-2">
            <h4> <i class="fa fa-life-ring"></i> Coin</h4>
