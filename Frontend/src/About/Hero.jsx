  ...
  return (
    <>
      <div className="container  border-bottom">
        <h1 className='fs-3 text-center' style={{ marginBottom : "90px" , marginTop : "90px"}} >We pioneered the discount broking model in India. <br />
          Now, we are breaking ground with our technology.</h1>


        <div className="row border-top mt-5  gx-4" style={{ color: "#666666" }} >
          <div className="col-1"></div>
          <div className="col mt-5 mb-5 p-5">
          ...
          <div className="col mt-5 mb-5 p-5 " style={{ color: "#666666" }} >
            ...
            <p className='fs-5'> <a href="" className='text-decoration-none'>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
